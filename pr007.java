...
//Влияния автопреобразование типов на перегрузку методов
class Overload2 {
	void f(int x) {
...
class pr007 {
	public static void main(String[] args) {
		Mod ob = new Mod();
		//Изменение и просмотр значения закрытой переменной осуществляется через методы, заданные внутри класса
		ob.setAlpha(77);
		...
		System.out.println("Скрытая от показателя обработка ошибок: ");
		...
		//Пример использование методов класса с параметрами в виде объектов (Класс Block)
		System.out.println();
		...
		System.out.println("ob1 эквивалентен по объему ob3: " + ob1.sameV(ob3));
		...
		System.out.println("a11 и b11 после вызова метода ob4.Change: " + a11 + " " + b11);
		...
		ob6.change(ob6);
		System.out.println("ob6.a12 и ob6.b12: " + ob6.a12 + " " + ob6.b12);
		...
		resD = ob7.ovlDemo(5.1, 3.5);
                System.out.println("Результат вызова ob7.ovlDemo(4, 6): " + resD);
		System.out.println();
