...
class QDemo {
	public static void main(String[] args) {
		...
		//Извлекается элементы из очереди bigQ
		...
		System.out.print("Содержание q1: ");
		for(i2 = 0; i2<10; i2++) {
			ch = q1.get();
			System.out.print(ch);
		}
		...
		System.out.print("Содержание q2 (на базе массива): ");
                for(i2 = 0; i2<4; i2++) {
                        ch = q2.get();
                        System.out.print(ch);
                }
		...
		System.out.print("Содержание q3 (на базе очереди q1): ");
                for(i2 = 0; i2<10; i2++) {
                        ch = q3.get();
                        System.out.print(ch);
                }
