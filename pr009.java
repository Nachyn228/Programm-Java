...
class B extends A {
	/*
	void meth() {
		System.out.println("Ошибочная попытка переопределения метода с модификацией final");
	}
	*/
}
...
//		Демонстрация применение статистических переменных с модификатором final
